    ...
    <>
      <nav className="bg-[#2c3e50] md:fixed w-full z-10">
        <div className=" text-white md:py-8 py-4 md:px-16 px-3 flex flex-wrap mx-auto justify-between items-center max-w-screen-xl">
          ...
          <button data-collapse-toggle="navbar-default" onClick={showNavBar} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
          ...
          {open ? (
            ...
            >
              <ul className="uppercase text-sm md:text-lg font-medium flex flex-col md:flex-row md:space-x-6">
                <NavLink to="about" className="rounded-md p-1 my-1 md:m-0 block">
                  about
                </NavLink>
                <NavLink to="portfolio" className="rounded-md p-1 my-1 md:m-0 block">
                  portfolio
                </NavLink>
                <NavLink to="contact" className="rounded-md p-1 my-1 md:m-0 block">
                  contact
                </NavLink>
              </ul>
            </div>
